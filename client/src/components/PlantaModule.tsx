  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-32 rounded-2xl overflow-hidden shadow-lg shadow-emerald-900/10">
        <img src="/manus-storage/bird-alexandrines_3b8aaf93.jpeg" alt="Planta" className="w-full h-full object-cover object-center" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex items-end p-5">
          <div>
            ...
            <h1 className="text-white text-xl lg:text-2xl font-bold tracking-tight">Planta Baixa</h1>
