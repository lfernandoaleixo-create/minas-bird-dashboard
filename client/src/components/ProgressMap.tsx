  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      <div className="relative h-44 rounded-2xl overflow-hidden shadow-lg shadow-emerald-900/10">
        <img src="/manus-storage/hero-mapa_6c749206.png" alt="Mapa de Progresso" className="w-full h-full object-cover object-center" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex items-end p-7">
          <div>
            ...
            <h1 className="text-white text-2xl lg:text-3xl font-bold tracking-tight">Mapa de Progresso</h1>
